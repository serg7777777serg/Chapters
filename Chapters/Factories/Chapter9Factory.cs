            ...
            using (var stream = ReadData())
            {
                ...
                switch (number)
                {
                    case TaskNumber.Task1:
                        var A1 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        var res1 = A1.Count(x => char.IsPunctuation(x));
                        return new object[] {res1};

                    case TaskNumber.Task2:
                        var A2 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        var res2 = A2.Count(x => x == '.' || x == '!');
                        return new object[] {res2};

                    case TaskNumber.Task3:
                        var A3 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        var temp3 = A3.Where(x => x != ',').ToArray();
                        var res3 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromCharsArray, temp3);
                        return new object[] {res3};

                    case TaskNumber.Task4:
                        var A4 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        A4.RemoveSpacesBeforePunctuation();
                        return new object[] {A4};

                    case TaskNumber.Task5:
                        var A5 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        A5.InsertNumberAfterSpaces(12345);
                        return new object[] {A5};

                    case TaskNumber.Task6:
                        var A6 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        A6.InsertNumberBeforeExclamation(123456);
                        return new object[] {A6};

                    case TaskNumber.Task7:
                        var A7 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        var res7 = A7.ExtractNumbers().Sum();
                        return new object[] {res7};

                    case TaskNumber.Task8:
                        var A8 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        var temp8 = A8.Where(x => !char.IsDigit(x)).ToArray();
                        var res8 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromCharsArray, temp8);
                        return new object[] {res8};

                    case TaskNumber.Task9:
                        var A9 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        var res9 = A9.ExtractNumbers().Where(x => x.IsSimple(y=>y)).Sum();
                        return new object[] {res9};

                    case TaskNumber.Task10:
                        var A10 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        A10.DeleteMaxLengthWords();
                        return new object[] {A10};

                    case TaskNumber.Task11:
                        var A11 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        var res11 = A11.ExtractNumbers().Where(x => x.IsSimple(y=>y)).Count();
                        return new object[] {res11};

                    case TaskNumber.Task12:
                        var A12 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        A12.InsertSpaceAfterPunctuation();
                        return new object[] {A12};

                    case TaskNumber.Task13:
                        var A13 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        A13.ReverseWords();
                        return new object[] {A13};

                    case TaskNumber.Task14:
                        var A14 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        var res14 = A14.MinWordCount();
                        return new object[] {res14};

                    case TaskNumber.Task15:
                        var A15 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromString, input);
                        var res15 = A15.VowelEndLetterCount();
                        return new object[] {res15};

                    case TaskNumber.Task16:
                        var A16 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromFile, textData);
                        return new object[] { A16.CountWordsInAOddLines() };

                    case TaskNumber.Task17:
                        var A17 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromFile, textData);
                        return new object[] { A17.CountSimplesInTheText() };

                    case TaskNumber.Task18:
                        var A18 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromFile, textData);
                        return new object[] { A18.CountPunctuationsInTheEvenLines() };

                    case TaskNumber.Task19:
                        var A19 = Chapters.StringAlgorithms.Create(Chapter9TaskType.FromFile, textData);
